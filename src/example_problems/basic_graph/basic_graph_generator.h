...
public:
    explicit BasicGraphGenerator(T num_states, T num_actions)
        ...
        if (num_actions > num_states)
            throw std::invalid_argument("Each node of the graph cannot have more edges than the total number of nodes.");
    }
